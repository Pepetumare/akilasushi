                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('productos.update', $producto->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="precio" class="form-control" value="{{ old('precio', $producto->precio) }}" required min="0">
                        </div>
                        ...
                        <div class="mb-3 text-center">
                            ...
                            <img src="{{ asset('storage/' . $producto->imagen) }}" alt="Imagen Actual" class="img-fluid rounded" style="max-height: 150px;">
                        </div>
                        @endif
